...
classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/L04dsqqQO/model.json", modelLoaded);
...
function gotResults(error, result) {
    if (error) {
        ...
        console.log(result);
        document.getElementById("results_egesture_name").innerHTML = results[0].label;
        ...
        if(result[2].label == "victory")
        {
            document.getElementById("update_gesture2").innerHTML = "&#9996;"
        }
        if(result[2].label == "amazing")
        {
